...
public class HorarioDAOimpl extends ConexionDB implements HorarioDAO{
    ...
    public void insert(Horario horario) throws Exception {
        try {
            ...
            ps.setString(1, horario.getGestion());
            ps.setString(2, horario.getTurno());
            ps.setString(3, horario.getDia());
            ps.setInt(4, horario.getId_horas());
            ps.setInt(5, horario.getId_aula());
            ps.setInt(6, horario.getId_mat_par());
            ps.setInt(7, horario.getId_docente());
            ps.executeUpdate();
        } catch (Exception e) {
            throw e;
        } finally {
