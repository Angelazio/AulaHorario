    ...
    <body>
        <div class="container">
          ...
          <form action="HorarioControlador" method="post">
              ...
              <div class="mb-3">
                  <label for="" class="form-label" >Id horas</label>
                  <input type="text" class="form-control" name="gestion" value="${horario.id_horas}" placeholder="Escriba ">
                  <select name=""></select>
              </div>
              <div class="mb-3">
                  <label for="" class="form-label">Id Aula</label>
                  <input type="text" class="form-control" name="turno" value="${horaio.id_aula}" placeholder="Escriba ">
              </div>
              <div class="mb-3">
